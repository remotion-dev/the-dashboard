...
export const forOneRedEmployees: Employee[] = [
  ...
  },
  {
    ...
    birthday: [23, 3],
    employeeOfTheMonth:
      "As an industrial designer at For One Red, Annika has consistently demonstrated exceptional creativity, ingenuity, and a deep commitment to her work. Her designs have consistently met or exceeded the expectations of clients, and her contributions to the company have been instrumental in driving its success. In addition to her professional skills, Annika is also known for her positive attitude and sense of humor. She has a natural ability to make her colleagues feel at ease, and her infectious chuckle can lighten the mood in even the most stressful situations. Her upbeat personality has made her a favorite among both clients and coworkers, and she is always willing to lend a helping hand or offer advice when needed.",
  },
  {
    name: "Tomás Massano",
    picture: "tomas.jpeg",
